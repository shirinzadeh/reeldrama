<template>
    <div class="container">
        ...
        <template v-else>
            ...
            <div v-if="newUserPackage" 
                class="new-user-offer" 
                :class="{ 'selected': selectedPackage?._id === newUserPackage._id }"
                @click="handlePackageSelection(newUserPackage)"
            >
            ...
            <div class="packages-grid">
                <div v-for="pkg in regularPackages" :key="pkg._id" 
                    class="package-card" 
